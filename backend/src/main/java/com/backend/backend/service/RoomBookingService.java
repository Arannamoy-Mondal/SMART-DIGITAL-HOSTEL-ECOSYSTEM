...
public class RoomBookingService {
    ...
    @Transactional
    public @Nullable Object createRoomBooking(RoomBookingRequest request) throws Exception {
        try {
            ...
            RoomRentInformation roomRentInformation = RoomRentInformation.builder()
                    ...
                    .isActive(true)
                    .build();
            return roomRentInformationRepo.save(roomRentInformation);
        } catch (Exception e) {
            throw new Exception(e.getMessage());
        }
    }

    public @Nullable Object getAllRoomBooking() throws Exception {
        try {
            return roomRentInformationRepo.findAll();
        } catch (Exception e) {
    ...
    public @Nullable Object getRoomBookingByUserName(String userName) throws Exception {
        try {
            User user = userRepo.findByUserName(userName).orElseThrow(
                    () -> new Exception("no user found with username: " + userName));
            return roomRentInformationRepo.findByUser(user);
        } catch (Exception e) {
            throw new Exception(e.getMessage());
        }
    }
